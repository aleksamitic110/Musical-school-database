namespace Muzicka_skola.Forme
{
	partial class GlobalForm
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.panelDodatneFunkcijeNastavnik.Controls.Add(this.panelDodatneFunkcijePolaznik);
			...
			this.panelDodatneFunkcijePolaznik.Location = new System.Drawing.Point(3, 3);
			...
			this.panelDodatneFunkcijePolaznik.TabIndex = 7;
			// 
